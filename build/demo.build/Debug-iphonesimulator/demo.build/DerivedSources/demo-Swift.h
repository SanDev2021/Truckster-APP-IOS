...
SWIFT_CLASS("_TtC4demo23ContactUsViewController")
@interface ContactUsViewController : UIViewController
@property (nonatomic, weak) IBOutlet WKWebView * _Null_unspecified wbContact;
- (void)viewDidLoad;
- (IBAction)btnCall:(UIButton * _Nonnull)sender;
- (IBAction)btnEmail:(UIButton * _Nonnull)sender;
- (IBAction)btnNav:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end


@interface ContactUsViewController (SWIFT_EXTENSION(demo)) <MFMailComposeViewControllerDelegate>
@end
...
@interface HomeViewController (SWIFT_EXTENSION(demo)) <UIViewControllerTransitioningDelegate>
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified txtUser;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified txtPass;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lblUser;
...
- (void)viewDidLoad;
- (IBAction)btnHelp:(UIBarButtonItem * _Nonnull)sender;
- (IBAction)userLogin:(UIButton * _Nonnull)sender;
...
@interface MapViewController (SWIFT_EXTENSION(demo)) <MKMapViewDelegate>
...
SWIFT_CLASS("_TtC4demo18MenuViewController")
...
SWIFT_CLASS("_TtC4demo21PaymentViewController")
@interface PaymentViewController : UIViewController <UIPickerViewDataSource, UIPickerViewDelegate>
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified txtCardType;
@property (nonatomic, weak) IBOutlet UIPickerView * _Null_unspecified dropdown;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified txtNameCard;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified txtCardNo;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified txtExpDate;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified txtCvvNo;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified txtBillAdd;
...
- (IBAction)saveBtnPressed:(UIButton * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface PostalCodeMapViewController (SWIFT_EXTENSION(demo)) <MKMapViewDelegate>
- (MKOverlayRenderer * _Nonnull)mapView:(MKMapView * _Nonnull)mapView rendererForOverlay:(id <MKOverlay> _Nonnull)overlay SWIFT_WARN_UNUSED_RESULT;
@end


SWIFT_CLASS("_TtC4demo21ProfileViewController")
@interface ProfileViewController : UIViewController
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lblname;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified lblLName;
...
SWIFT_CLASS("_TtC4demo20SignUpViewController")
...
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified imgBtn;
@property (nonatomic, weak) IBOutlet UIImageView * _Null_unspecified imagePlace;
- (void)viewDidLoad;
- (IBAction)btnRegister:(id _Nonnull)sender;
- (IBAction)imgBtnTapped:(UIButton * _Nonnull)sender;
...
SWIFT_CLASS("_TtC4demo10Transition")
